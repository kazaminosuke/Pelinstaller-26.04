...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/kazaminosuke/Pelinstaller-26.04"}
...
welcome() {
  ...
  output "https://github.com/ratx0x0/Pelinstaller-26.04"
  output ""
